...
| K8s / container security | IngressNightmare (CVE-2025-1974 CVSS 9.8, ~43% cloud K8s), RBAC escalation (create pods → node escape), IMDS credential theft (EKS hop limit bypass), Kyverno namespace escape (CVE-2026-22039 CVSS 10.0), Argo CD credential leak (CVE-2025-55190 CVSS 10.0), Istio mTLS permissive mode bypass, container registry public exposure | cloud-security/reference/kubernetes-security.md |
