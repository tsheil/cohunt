...
| **AI coding IDEs** | Project file supply chain (hooks, MCP configs, env vars), extension recommendation squatting, legacy browser flaws | IDEsaster: 30+ vulns, 24 CVEs across Claude Code, Cursor, Kiro, Windsurf; 94+ Chromium CVEs affecting 1.8M devs; OpenVSX namespace squatting |
| **MCP integrations** | Tool poisoning, rug pull attacks, command injection (CVE-2025-6514, CVSS 10.0), eval() epidemic, SDK cross-client leaks, WebSocket hijacking, sandbox escape, cross-system data exfiltration | 8,000+ servers exposed (Feb 2026), 492 vulnerable; 7 RCE CVEs in Feb 2026 from eval(); CVE-2026-25536 SDK data leak; ClawJacked WebSocket hijack; Adversa AI TOP 25; VulnerableMCP.info tracks CVEs |
