...
Attack patterns targeting infrastructure components: browser exploits, Node.js sandboxing, SSRF chains, remote access tools, MDM platforms, webmail, critical network infrastructure, and Windows trust mechanism bypasses. Reference file for the infrastructure-security skill.
...
|-----|------|-----------|------|
| CVE-2026-21536 | 9.8 | Devices Pricing Program | Unauth RCE via unrestricted file upload (CWE-434) — first AI-agent-discovered Windows CVE (XBOW), cloud-only service already patched |
