...
- [Advanced Jailbreak & Injection Techniques](#advanced-jailbreak--injection-techniques) (→ [llm-attack-techniques.md](llm-attack-techniques.md))
...
> **Full reference:** See [llm-attack-techniques.md](llm-attack-techniques.md) for 9 advanced techniques: JBF (papers→attacks), TAO-Attack (two-stage optimization), autonomous jailbreak agents (97.14% success), Unit42 IDPI catalog (22 in-the-wild techniques), Zscaler enterprise failure rates (100% critical flaws), encoding/multilingual/visual concealment bypasses, semantic chaining, and hybrid XSS+PI attacks.
