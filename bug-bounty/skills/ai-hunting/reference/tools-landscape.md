...
- **Equixly Agentic AI Hacker** (EUR10M Series A, December 2025) — MCP-aware autonomous pentesting using reinforcement learning; specifically targets MCP servers; **benchmark: 230 vulns in 1 hour across 30 challenges vs 15 human pentesters solving 14/30 in 2+ hours**; 80% more findings than ZAP DAST; 8 high-severity vulns missed by DAST; 43% of popular MCP server implementations have command injection (Equixly audit); first dedicated autonomous MCP pentesting tool
