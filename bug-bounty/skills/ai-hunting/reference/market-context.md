...
- **30 MCP CVEs in 60 days** (Adversa AI March digest); **38%** of 500+ scanned servers completely lack authentication; **43% vulnerable to command execution**. MCP vulnerability rate accelerating, not plateauing
