...
- **XBOW #1 on HackerOne US leaderboard** (March 2026): 1,060+ submissions in 90 days (54 critical, 242 high, 524 medium); 130 resolved, 303 triaged; **85% solve rate on custom never-before-seen challenges**; **80x faster** than manual teams; launched **XBOW Pentest On-Demand** ($6K/engagement, 5 business days); pivoting to pre-production scanning; still operating at loss — compute exceeds bounty earnings
...
- **OpenAI acquires Promptfoo** (March 9, 2026): open-source LLM red-teaming CLI ($86M valuation, 125K+ devs, 30+ Fortune 500); pledged open-source continuity; frontier labs consolidating AI red-team tooling
...
- **Microsoft Patch Tuesday March 11 update**: 79-83 CVEs (BleepingComputer: 79 flaws; Tenable: 83 CVEs including Edge/Chromium); 2 zero-days publicly disclosed + 3 Critical (Excel info disclosure CVE-2026-26144 exploitable via Copilot Agent mode, Office RCE CVE-2026-26113, Office RCE CVE-2026-26110)
